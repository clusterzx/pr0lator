...
export type DeleteItemReason = "Regel #1 - Bild unzureichend getagged (nsfw/nsfl)" | "Regel #2 - Gore/Porn/Suggestive Bilder mit Minderjährigen" | "Regel #3 - Tierporn" | "Regel #4 - Stumpfer Rassismus/Nazi-Nostalgie" | "Regel #5 - Werbung/Spam" | "Regel #6 - Infos zu Privatpersonen" | "Regel #7 - Bildqualität" | "Regel #8 - Ähnliche Bilder in Reihe" | "Regel #12 - Warez/Logins zu Pay Sites" | "Regel #14 - Screamer/Sound-getrolle" | "Regel #15 - reiner Musikupload" | "Repost" | "Auf Anfrage";
